...
//创建主区率估计对象
        ...
        viewer->addPointCloudNormals<pcl::PointXYZ,pcl::Normal>(cloud,cloud_normal,10,5);
        viewer->addPointCloudPrincipalCurvatures(cloud,cloud_normal,principal_curvatures,5,300,"cloud1");
