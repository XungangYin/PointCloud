...
float support_size =0.1f; //设置关键点搜索半径
...
main (int argc, char** argv)
{
  ...
  pcl::NarfKeypoint narf_keypoint_detector (&range_image_border_extractor);//设置narfkeypoint对象
  narf_keypoint_detector.setRangeImage (&range_image);
  narf_keypoint_detector.getParameters ().support_size = support_size;  //设置空间球体的半径
  narf_keypoint_detector.getParameters ().add_points_on_straight_edges = true;  //直边，观察效果显示感觉平面上的一部分点也是关键点
